...
import com.example.yks93.roomiedemo717.AfterTheFirstClickActivity;
...
import com.example.yks93.roomiedemo717.signup_actions.SignupOneData;
...
public class LoginPageActivity extends AppCompatActivity{
    ...
    public class TryLoginThread extends HandlerThread {
        ...
        public void run() {
            ...
            Call<List<SignupOneData>> call = service.tryLoginNow(
            ...
            call.enqueue(new Callback<List<SignupOneData>>() {
                ...
                public void onResponse(Call<List<SignupOneData>> call, Response<List<SignupOneData>> response) {
                    ...
                    else if (code != 200 && tryNetworkCount > 0) {
                        this.onFailure(call.clone(), new Throwable());
                        --tryNetworkCount;
                    }
                }
